...
# Ubuntu Linux
    ...
    sudo apt-get update; sudo apt-get -y install cmake make gcc python-setuptools python-dev build-essentials tig flake8 appnexus-maestro-tools python3-pip python-yaml npm nodejs redis-server schema-tool python-psycopg2
